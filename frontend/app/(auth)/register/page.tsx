...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-secondary via-brand-primary to-brand-tertiary p-16 flex-col justify-between relative overflow-hidden">
        ...
        <div className="space-y-8 relative z-10">
          <div>
            ...
            <p className="text-lg text-white/80 max-w-md" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Hemen başlayın ve akademik yazılarınızı yapay zeka ile geliştirin.
            </p>
          </div>
          ...
          <div className="space-y-4 max-w-md">
            <div className="flex items-center gap-3 text-white/90">
              ...
              <p className="text-base">Anında başlayın, kredi kartı gerekmez</p>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <div className="flex-shrink-0 w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm">
                <span className="text-lg">🔒</span>
              </div>
              <p className="text-base">Verileriniz güvende ve şifreli</p>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <div className="flex-shrink-0 w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm">
                <span className="text-lg">🚀</span>
              </div>
              <p className="text-base">Sınırsız proje ve belge</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-white p-8 lg:p-16">
        <div className="w-full max-w-md space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">Ücretsiz hesabınızı oluşturun</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Contact Input */}
            <div className="group">
              <label className="block text-sm font-medium text-gray-700 mb-2">İletişim Numarası (Opsiyonel)</label>
              <input
                type="tel"
                name="contact"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-brand-primary to-brand-secondary text-white rounded-xl font-semibold hover:shadow-xl hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-brand-primary/30 text-[16px] mt-6"
              style={{ fontFamily: 'Poppins, sans-serif' }}
            >
              {loading ? (
            ...
            <div className="flex justify-center gap-3">
              <button type="button" className="p-3 rounded-xl hover:bg-gray-50 transition-all hover:scale-110 duration-200">
                <svg className="w-10 h-10" viewBox="0 0 42 42" fill="none">
                  <circle cx="21" cy="21" r="18" fill="url(#facebook-reg)" />
                  ...
                  <defs>
                    <linearGradient id="facebook-reg" x1="21" y1="3" x2="21" y2="39" gradientUnits="userSpaceOnUse">
          ...
          {/* Login Link - Tüm ekranlarda göster */}
